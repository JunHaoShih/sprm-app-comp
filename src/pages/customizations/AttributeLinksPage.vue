...
import AttributeLinkPanel from '../../modules/customs/components/AttributeLinkPanel.vue';
import { ObjectType } from '../../modules/objectTypes/models/ObjectType';
import { objectTypeService } from '../../modules/objectTypes/ObjectTypeService';
